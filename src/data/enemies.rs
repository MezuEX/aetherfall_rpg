...
pub fn get_enemy_team_chapter1() -> Vec<Character> {
    let skills = vec![Skill::new("Serangan Gelap", 100, 0, None, "Serangan dasar kegelapan.")];
    let ultimate = Skill::new("Null Void", 150, 100, None, "Void menghancurkan target.");
...
pub fn get_enemy_team_chapter2() -> Vec<Character> {
    let skills = vec![Skill::new("Tebasan Bayangan", 120, 0, None, "Tebasan dari bayangan.")];
    let ultimate = Skill::new("Void Storm", 180, 100, None, "Badai void menghancurkan semua.");
...
pub fn get_enemy_team_chapter3() -> Vec<Character> {
    let skills = vec![Skill::new("Pukulan Gila", 140, 0, None, "Pukulan brutal tanpa ampun.")];
    let ultimate = Skill::new("Rage", 220, 100, None, "Kemarahan murni menghancurkan musuh.");
...
pub fn get_enemy_team_chapter4() -> Vec<Character> {
    let skills = vec![Skill::new("Frost Blast", 130, 0, Some(Effect::Freeze), "Ledakan es membekukan target.")];
    let ultimate = Skill::new("Glacier", 200, 100, Some(Effect::Freeze), "Gletser raksasa membekukan semua musuh.");
...
pub fn get_final_boss() -> Character {
    let skills = vec![
        Skill::new("Null Wave", 160, 0, Some(Effect::DebuffDef(20)), "Gelombang void menurunkan pertahanan."),
        Skill::new("Void Erosion", 120, 0, Some(Effect::Burn(15)), "Erosi void membakar musuh."),
    ];
    let ultimate = Skill::new("Absolute Zero", 400, 100, None, "Kemampuan pamungkas Sovereign.");
